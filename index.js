function App() {
  let data = [
    ...
    { title: "Princess Bride", img: 'images/princess_bride.webp', desc: "A cowboy doll is profoundly threatened and jealous when a new spaceman figure supplants him as top toy in a boy's room." },
  ]
...
} // By convention, any component that is intended to be displayed on the 
// screen, start with uppercase to show that its not a normal function. 
...
function Movie(props){
  ...
  <div class="actions">
    <a class="details" href="#">See Details</a>
